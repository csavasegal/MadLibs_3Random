...
jsPsych.plugins['survey-html-form'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add submit button CHANGED HERE
    // The first one is just the typical submit button
    ...
    // This is the delayed submit button
    html += '<div class="jspsych-survey-html-form-next style="display: block; margin:'+trial.margin_vertical+' '+trial.margin_horizontal+'" id="skip-button" data-choice="skip"><button class="jspsych-btn jspsych-survey-html-form" style="visibility:hidden;">Continue</button></div>';
    ...
    if (trial.trial_duration !== null) {
        jsPsych.pluginAPI.setTimeout(function() {
            display_element.querySelector('#jspsych-survey-html-form').requestSubmit();
