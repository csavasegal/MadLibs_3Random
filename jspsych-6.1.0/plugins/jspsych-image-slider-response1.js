 ...
 *
 */
// CSS modified to add border color 
...
jsPsych.plugins['image-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<img src="'+trial.stimulus+'" style="border: .5px solid black; padding: 5px 5px 5px 5px; background-color: '+trial.border_color+'';
    ...
    html += '"></img>';
    html += '<br>' +  '<br>' ; //ADDED SPACE TO ALIGN
