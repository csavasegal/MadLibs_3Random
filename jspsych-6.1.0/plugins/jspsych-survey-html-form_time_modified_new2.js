...
jsPsych.plugins['survey-html-form-modified2'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'ssurvey-html-form-modified2',
    description: '',
    parameters: {
      html: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if(trial.require_movement){
      display_element.querySelector('#jspsych-image-slider-response-next').addEventListener('change', function(){
