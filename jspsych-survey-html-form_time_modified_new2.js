...
jsPsych.plugins['survey-html-form'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // added in to force movement
    if(trial.require_movement){
      var currTime = performance.now();
      if(currTime == 5000);
      display_element.querySelector('#jspsych-survey-html-form-next').addEventListener('change', function(){
    ...
    //html += '<input type="submit" id="jspsych-image-slider-response-next" class="jspsych-btn jspsych-survey-html-form" '+ (trial.require_movement ? "disabled" : "") + '>'+trial.button_label+'</input>';
