...
jsPsych.plugins['survey-html-form-nosubmit'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'survey-html-form-nosubmit',
    description: '',
    parameters: {
      html: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if ( trial.autocomplete ) {
      html += '<form id="survey-html-form-nosubmit">'
    } else {
      html += '<form id="survey-html-form-nosubmit" autocomplete="off">'
    }
    ...
    display_element.querySelector('#survey-html-form-nosubmit').addEventListener('submit', function(event) {
      // don't submit form
    ...
    var end_trial = function() { // CSS ADDED
    ...
    //         //display_element.querySelector('#jspsych-survey-html-form-next').requestSubmit();
